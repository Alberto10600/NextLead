    ...
    >
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-slate-200 bg-[#0f172a] rounded-md px-3 py-2 border border-[#334155]">
        ...
        <div>
          ...
          <div className="text-sm text-slate-300 bg-[#0f172a] rounded-md px-3 py-3 border border-[#334155] whitespace-pre-wrap leading-relaxed min-h-[120px]">
            {contacto.email_generado}
          </div>
        </div>
