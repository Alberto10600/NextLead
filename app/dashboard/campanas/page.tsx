  ...
  return (
    <div className="min-h-full">
      ...
      <div className="border-b border-gray-200 bg-white px-6 py-4 flex items-center justify-between">
        <div>
          <h1 className="text-base font-semibold text-gray-900 tracking-tight">Campañas</h1>
      ...
      <div className="p-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-28 text-center">
            <p className="text-gray-800 font-medium mb-1.5">No tienes campañas todavía</p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left px-5 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider w-[30%]">
                    Campaña
                  </th>
                  ...
                  <th className="text-left px-5 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider tabular-nums">
                    Contactos
                  </th>
                  <th className="text-left px-5 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">
                    Creada
                ...
                {campanas.map((c) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5 text-gray-500 tabular-nums text-sm">
                        {c.total_contactos ?? 0}
                      </td>
                      <td className="px-5 py-3.5 text-gray-400 text-xs">{formatearFecha(c.created_at)}</td>
                      <td className="px-5 py-3.5">
                        <div className="flex items-center justify-end gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                          <button
                            onClick={() => router.push(`/dashboard/campanas/${c.id}/editar`)}
                            className="px-2.5 py-1 text-xs text-gray-500 hover:text-gray-800 hover:bg-gray-50 rounded transition-colors duration-100"
